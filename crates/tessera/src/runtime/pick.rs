...
pub(super) struct PendingPick {
    pub(super) conn_id: u64,
    pub(super) kind: tessera_protocol::PickKind,
    pub(super) reply: std::sync::mpsc::Sender<Result<tessera_protocol::PickResult, String>>,
}

/// Map an IPC pick kind onto the selector's interaction mode.
pub(super) fn picker_mode(
    kind: tessera_protocol::PickKind,
) -> tessera_shell::component::PickerMode {
    match kind {
        tessera_protocol::PickKind::Region => tessera_shell::component::PickerMode::Region,
        tessera_protocol::PickKind::Pixel => tessera_shell::component::PickerMode::Pixel,
        tessera_protocol::PickKind::Window => tessera_shell::component::PickerMode::Window,
        tessera_protocol::PickKind::Output => tessera_shell::component::PickerMode::Output,
    }
}
...
mod tests {
    ...
    fn pick_kinds_map_to_picker_modes() {
        assert_eq!(
            picker_mode(tessera_protocol::PickKind::Region),
            tessera_shell::component::PickerMode::Region
        );
        assert_eq!(
            picker_mode(tessera_protocol::PickKind::Pixel),
            tessera_shell::component::PickerMode::Pixel
        );
        assert_eq!(
            picker_mode(tessera_protocol::PickKind::Window),
            tessera_shell::component::PickerMode::Window
        );
        assert_eq!(
            picker_mode(tessera_protocol::PickKind::Output),
            tessera_shell::component::PickerMode::Output
        );
    }
}
