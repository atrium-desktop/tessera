...
pub(super) enum ConfirmPickControl {
    ...
    Start {
        ...
        style: tessera_shell::component::ConfirmPickStyle,
        reply: std::sync::mpsc::Sender<Result<tessera_shell::component::ConfirmAnswer, String>>,
    },
...
pub(super) struct PendingConfirmPick {
    pub(super) conn_id: u64,
    pub(super) reply:
        std::sync::mpsc::Sender<Result<tessera_shell::component::ConfirmAnswer, String>>,
}
...
impl CompositorRuntime<'_> {
            ...
            match request.action {
                ConfirmPickControl::Start {
                        ...
                        || self.pending_pick.is_some()
                    {
                        ...
                        self.shell.start_confirm_pick(
                            tessera_shell::component::ConfirmPickParams {
                                title,
                                body,
                                accept_label,
                                style,
    ...
    fn request_system_action_confirmation(
        &mut self,
        ...
        self.shell
            .start_confirm_pick(tessera_shell::component::ConfirmPickParams {
