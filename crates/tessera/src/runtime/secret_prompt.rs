...
pub(super) enum SecretPromptControl {
    ...
    Start {
        ...
        reply: std::sync::mpsc::Sender<Result<tessera_protocol::SecretPromptResult, String>>,
    },
...
pub(super) struct PendingSecretPrompt {
    pub(super) conn_id: u64,
    pub(super) reply: std::sync::mpsc::Sender<Result<tessera_protocol::SecretPromptResult, String>>,
}
            ...
            match request.action {
                SecretPromptControl::Start {
                        ...
                        || self.pending_pick.is_some()
                    {
                        ...
                        self.shell.start_secret_prompt(
                            tessera_shell::component::SecretPromptParams { title, reason },
                        );
                    }
                }
