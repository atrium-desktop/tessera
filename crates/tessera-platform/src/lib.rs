...
use tessera_desktop::output::OutputGeometry;
...
pub trait Backend {
    ...
    fn set_configured_modes(
        &mut self,
        _modes: std::collections::HashMap<String, tessera_desktop::output::ModeSpec>,
    ) {
    }
    ...
    fn set_configured_color_policies(
        &mut self,
        _policies: std::collections::HashMap<String, tessera_desktop::output::ColorPolicy>,
    ) {
    }
    ...
    fn color_pipeline(&self) -> tessera_desktop::output::ColorPipeline {
        tessera_desktop::output::ColorPipeline::Sdr
    }
