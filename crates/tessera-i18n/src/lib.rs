...
impl Localizer {
    ...
    pub fn text(self, message: Message) -> &'static str {
        ...
        match message {
            ...
            Message::Wallpaper => &catalog.wallpaper,
            Message::WallpaperMode => &catalog.wallpaper_mode,
            Message::WallpaperSource => &catalog.wallpaper_source,
            Message::WallpaperModeImage => &catalog.wallpaper_mode_image,
            Message::WallpaperMode3d => &catalog.wallpaper_mode_3d,
            Message::WallpaperModeVideo => &catalog.wallpaper_mode_video,
            Message::WallpaperModeParallax => &catalog.wallpaper_mode_parallax,
            Message::WallpaperBuiltin => &catalog.wallpaper_builtin,
            ...
            Message::CommandPanel | Message::ControlCenter => &catalog.control_center,
...
struct Catalog {
    ...
    wallpaper_mode_image: String,
    wallpaper_mode_3d: String,
    wallpaper_mode_video: String,
    wallpaper_mode_parallax: String,
    wallpaper_builtin: String,
    dock: String,
