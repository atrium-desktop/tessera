...
pub use stream::{
    ...
    render_window_stream_dmabuf, render_window_stream_shm, resolve_output_rect,
    submit_capture_frame, window_stream_cursor, window_stream_render_due, BlitFailure,
    CaptureCursorState, DmabufCapture, DmabufStream, GeometryAction, OutputStream,
    OutputStreams, PendingSlotFrame, PresentedFrameRef, SampledDamage, WindowShmTarget,
    SlotRing, SlotState, StreamCursorBlit, StreamPainter, WindowDriveEffects, WindowStream,
    WindowStreamDrive, WindowStreamStage, WindowTreeGeometry, DRM_FORMAT_XRGB8888,
    LIVENESS_INTERVAL, SLOT_FENCE_TIMEOUT, STREAM_SLOT_COUNT,
};
