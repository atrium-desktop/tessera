...
pub trait Handler: Send + Sync {
    ...
    fn enumerate_outputs(&self) -> Vec<tessera_protocol::schema::OutputInfo> {
        tessera_protocol::schema::OutputInfo::project(&self.outputs())
    }
    /// Snapshot of journal entries with `seq > since` (ADR-0033).
    fn journal_since(&self, since: u64) -> tessera_protocol::journal::JournalSnapshot;
    ...
    fn system_status(&self) -> tessera_desktop::system::SystemStatus {
        tessera_desktop::system::SystemStatus::default()
    }
    ...
    fn start_actor_session(
        ...
        Ok(tessera_authority::authority::ActorSessionSnapshot {
            id: tessera_authority::authority::ActorSessionId(conn_id),
            principal,
            connection_id: conn_id,
            state: tessera_authority::authority::ActorSessionState::Active,
    ...
    fn issue_resource_grant(
        ...
        _resource: tessera_authority::authority::ActorResource,
    ...
    fn audit_capability_use(
        ...
        _action: tessera_protocol::journal::CapabilityUseAction,
        _effect: tessera_protocol::journal::Effect,
    ) {
    }
    ...
    fn system_action(
        ...
        _conn_id: u64,
        _subject: Option<&str>,
        _action: tessera_protocol::schema::SystemAction,
    ) -> Result<(), String> {
    ...
    fn transact(
        ...
        _ops: Vec<Command>,
    ) -> Result<tessera_protocol::schema::TransactResult, String> {
    ...
    fn capture_window(
        ...
        _conn_id: u64,
        _subject: Option<&str>,
        _window: tessera_desktop::window::WindowId,
    ...
    fn discard_observation(
        ...
        _conn_id: u64,
        _subject: Option<&str>,
        _token: &tessera_protocol::schema::ObservationToken,
    ) {
    }
    ...
    /// [`tessera_protocol::schema::StreamTarget::Output`] (version 29). `allow_dmabuf`
    ...
    fn stream_output_start(
        ...
        _conn_id: u64,
        _max_fps: Option<u32>,
        _target: tessera_protocol::schema::StreamTarget,
        _allow_dmabuf: bool,
        _cursor: tessera_protocol::schema::StreamCursorMode,
    ...
    fn pick_target(
        &self,
        _conn_id: u64,
        _kind: tessera_protocol::schema::PickKind,
    ) -> Result<tessera_protocol::schema::PickResult, String> {
    ...
    ) -> Result<tessera_protocol::schema::AppPickResult, String> {
    ...
    ) -> Result<tessera_protocol::schema::SecretPromptResult, String> {
    ...
    ) -> Result<tessera_protocol::schema::ConfirmPickResult, String> {
