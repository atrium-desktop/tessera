...
mod tests {
    ...
    use tessera_protocol::{ActorCapability, ConnectionCapabilities};
    ...
    impl Handler for TestHandler {
        ...
        fn command(&self, _conn_id: u64, _subject: Option<&str>, _cmd: tessera_protocol::Command) {}
        fn agent_lookup(
            &self,
            credential: &str,
        ) -> Option<tessera_authority::authority::AgentIdentity> {
            (credential == "cred_test").then(|| tessera_authority::authority::AgentIdentity {
