...
pub use tessera_authority::authority::{AgentIdentity, PairedAgent};
use tessera_protocol::journal::{JournalEntry, JournalMutation};
...
pub struct CaptureWindowPayload {
    pub capture: tessera_protocol::schema::WindowCapture,
    pub png: Vec<u8>,
}
