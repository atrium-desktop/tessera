...
use crate::widgets::menu::DEFAULT_MENU_HEADER_HEIGHT;
use crate::widgets::menu::DEFAULT_MENU_PAD;
use crate::widgets::menu::DEFAULT_MENU_ROW_HEIGHT;
use crate::widgets::menu::DEFAULT_MENU_SECTION_HEIGHT;
use crate::widgets::menu::DEFAULT_MENU_WIDTH;
...
pub struct AppMenu {
    ...
    /// registration by [`Shell::add`](crate::component::Shell::add) and refreshed when the
...
impl AppMenu {
    ...
    /// [`Chrome::backdrop_regions`](crate::component::Chrome::backdrop_regions) and
    /// [`Chrome::liquid_glass_regions`](crate::component::Chrome::liquid_glass_regions)
...
mod tests {
    use super::*;
    use crate::component::{POPUP_GAP, POPUP_MARGIN, place_popup};
    ...
    fn unicode_truncation_preserves_character_boundaries() {
        assert_eq!(crate::component::truncate("窗口操作", 3), "窗口…");
    }
