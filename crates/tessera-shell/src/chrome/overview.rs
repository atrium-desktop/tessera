...
//! thumbnails onto the grid computed by the shared `crate::layout::overview`
...
use crate::layout::overview as geom;
use tessera_authority::interaction_domain::InteractionDomain;
use tessera_authority::interaction_domain::InteractionDomainId;
use tessera_authority::interaction_domain::InteractionDomainKind;
...
pub struct Overview {
    ...
    drag_candidate: Option<tessera_desktop::window::WindowId>,
...
impl Chrome for Overview {
    fn render(
        ...
        let rail_tiles: Vec<(tessera_desktop::workspace::WorkspaceId, bool)> = workspaces
            .outputs
            .first()
            .map(|o| {
                o.workspaces
