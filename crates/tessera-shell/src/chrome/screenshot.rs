...
pub struct ScreenshotSelector {
    ...
    /// [`crate::SystemStatus`].
    outputs: Vec<tessera_desktop::output::OutputInfo>,
...
impl ScreenshotSelector {
    ...
    fn output_at(outputs: &[tessera_desktop::output::OutputInfo], cursor: Point) -> Option<String> {
        outputs
            .iter()
            .find(|output| {
...
mod tests {
    ...
    fn output_mode_status_updates_refresh_the_hit_test_snapshot() {
        ...
        let status = crate::SystemStatus {
            display: tessera_desktop::settings::DisplayStatus {
                outputs: vec![test_output("HDMI-A-1", 0, 0, 1920, 1080)],
                ..tessera_desktop::settings::DisplayStatus::default()
            },
