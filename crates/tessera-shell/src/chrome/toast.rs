...
mod tests {
    ...
    fn toast_copy_is_unicode_safe_and_bounded() {
        assert_eq!(
            crate::component::truncate("Fuji connected", 20),
            "Fuji connected"
        );
        assert_eq!(
            crate::component::truncate("真实通知已经联通", 6),
            "真实通知已…"
        );
    }
