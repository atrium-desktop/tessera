...
pub(crate) struct PendingLaunchPlacement {
    ...
    pub(crate) placement: tessera_desktop::workspace::LaunchPlacement,
...
) -> Option<tessera_desktop::workspace::LaunchPlacement> {
...
impl Server {
    ...
    pub fn register_launch_placement(
        ...
        app_ids: Vec<String>,
        pid: Option<u32>,
        placement: tessera_desktop::workspace::LaunchPlacement,
    ) {
...
mod tests {
    ...
    fn entry(
        ...
        PendingLaunchPlacement {
            ...
            pid,
            placement: tessera_desktop::workspace::LaunchPlacement::FreshWorkspace {
    ...
    fn label_of(placement: Option<tessera_desktop::workspace::LaunchPlacement>) -> Option<String> {
        match placement {
            Some(tessera_desktop::workspace::LaunchPlacement::FreshWorkspace { label }) => label,
