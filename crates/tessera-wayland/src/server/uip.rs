//! Universal Interaction Protocol (UIP) frame dispatch and routing in tessera-wayland.
...
impl Server {
    ...
    fn dispatch_uip_semantic(
        ...
        if domain_rec.state != tessera_authority::interaction_domain::InteractionDomainState::Active
        {
            return Ok(UipDispatchResult::Rejected(
