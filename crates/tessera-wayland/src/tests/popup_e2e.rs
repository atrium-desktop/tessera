...
fn new_test_server_scaled(scale: f32) -> Option<Server> {
    ...
    server.set_output_geometry(tessera_desktop::output::OutputGeometry {
...
fn keymap() -> tessera_desktop::keybind::Keymap {
    tessera_desktop::keybind::Keymap::default()
}
...
fn chrome_tooltips_keep_their_requested_size() {
    ...
    let keymap = tessera_desktop::keybind::Keymap::default();
    let y = origin.y + 64;
