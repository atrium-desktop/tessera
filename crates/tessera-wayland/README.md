...
`tessera-wayland` is the hand-rolled Wayland server and window-management mechanism
for tessera.
...
- Expose renderer- and shell-friendly snapshots built from `tessera-desktop` models.
...
2. Forwards input from `tessera-platform`.
