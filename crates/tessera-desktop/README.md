...
`tessera-desktop` is the backend-, protocol-, and renderer-agnostic state and
...
`tessera-desktop` performs no Wayland, Vulkan, flux, lens, filesystem, socket, or
...
```rust
use tessera_desktop::{Point, Rect};
