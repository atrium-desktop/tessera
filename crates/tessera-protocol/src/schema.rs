...
use tessera_authority::interaction_domain::InteractionDomainWindowPlacement;
...
pub use tessera_desktop::settings::SettingsAction;
pub use tessera_desktop::settings::SettingsReceipt;
pub use tessera_desktop::settings::SettingsSnapshot;
pub use tessera_desktop::system::SystemAction;
...
use tessera_desktop::workspace::LaunchPlacement;
...
pub use tessera_authority::authority::ActorScope as Scope;
    ...
    pub fn validate(&self) -> Result<(), &'static str> {
        ...
        match self {
            ...
            Command::Screenshot { path, .. }
                if tessera_authority::authority::ActorResource::FilesystemPath {
                    path: PathBuf::from(path),
                    access: tessera_authority::authority::FilesystemAccess::Write,
                }
                .validate()
                .is_err() =>
            {
...
pub struct OutputInfo {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub geometry: Option<tessera_desktop::output::OutputGeometry>,
    /// Modes the connector advertises, populated for `GetOutputs` and
    /// [`Request::Observe`] replies only.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub available_modes: Option<Vec<tessera_desktop::output::OutputMode>>,
}
...
impl OutputInfo {
    ...
    pub fn project(infos: &[tessera_desktop::output::OutputInfo]) -> Vec<Self> {
...
pub enum Response {
    ...
    Hello {
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        session: Option<tessera_authority::authority::ActorSessionSnapshot>,
