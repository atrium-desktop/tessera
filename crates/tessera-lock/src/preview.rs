...
use tessera_lock::{AuthResult, LockAction, LockScreenStyle, LockState, PresentationMode, Secret};
use wayland_client::{
...
struct PreviewApp {
    ...
    expected_password: Option<Secret>,
...
fn parse_preview_password(value: &str) -> Result<Secret, String> {
    if value.is_empty() {
