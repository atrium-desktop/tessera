...
## Documentation Governance Standard (Protocol v6.0.0)

The standard is mirrored in [documentation/](documentation/core/index.md) and configured via [/.docgov.yml](../../.docgov.yml):
...
- [Invariants](documentation/core/invariants.md): Codified constitution of numbered system invariants (`[INV-LINT-*]`, `[INV-AGENT-*]`).
